...
export function Hero({ searchQuery, setSearchQuery, onSearch }: { searchQuery: string, setSearchQuery: (val: string) => void, onSearch: () => void }) {
  return (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-gray-400 text-lg md:text-xl max-w-3xl mx-auto mb-12">
            The ultimate portal for 25+ official certification links from tech giants. 
            Search, verify, and redirect to official portals instantly.
          </p>
            ...
            >
              <div className="relative flex-1">
                ...
                <Input
                  ...
                  placeholder="Enter company name (e.g. Google, AWS, Dell...)"
                  className="pl-12 h-14 bg-gray-900 border-gray-700 text-white placeholder:text-gray-500 focus:border-yellow-500"
                />
              </div>
              <Button 
                type="submit"
                className="h-14 px-8 bg-yellow-500 text-black hover:bg-yellow-400 font-medium"
              >
                Search Intel
